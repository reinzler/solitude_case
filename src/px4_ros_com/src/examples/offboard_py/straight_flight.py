...
def generate_linear_trajectory():
    ...
    x = np.arange(0.01, 1000.1, 0.01).tolist()
...
class OffboardControl(Node):
    ...
    def timer_callback(self) -> None:
        ...
        if self.vehicle_local_position.z > self.takeoff_height and self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD and not self.aruco_marker_detected:
